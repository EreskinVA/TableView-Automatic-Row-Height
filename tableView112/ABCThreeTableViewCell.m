...
@interface ABCThreeTableViewCell ()
...
@implementation ABCThreeTableViewCell
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    [_iconImageView.rightAnchor constraintEqualToAnchor:self.contentView.rightAnchor
                                              constant:-8.0].active = YES;
    ...
    [_titleLabel.topAnchor constraintEqualToAnchor:self.contentView.topAnchor
                                          constant:8.0].active = YES;
    [_titleLabel.heightAnchor constraintEqualToConstant:18.f].active = YES;
    
    [_titleLabel.leftAnchor constraintEqualToAnchor:self.contentView.leftAnchor
                                           constant:8.0].active = YES;
    [_titleLabel.rightAnchor constraintEqualToAnchor:_iconImageView.leftAnchor
                                            constant:-8.0].active = YES;
    ...
    [_subtitleLabel.bottomAnchor constraintEqualToAnchor:self.contentView.bottomAnchor
                                                constant:-8.0].active = YES;
    [_subtitleLabel.leftAnchor constraintEqualToAnchor:self.contentView.leftAnchor
                                              constant:8.0].active = YES;
    [_subtitleLabel.rightAnchor constraintEqualToAnchor:_iconImageView.leftAnchor
                                               constant:-8.0].active = YES;
    return self;
}
